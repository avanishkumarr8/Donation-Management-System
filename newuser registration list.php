...
<body>
   ...
   <p id="time" align="right"></p>
				...
				?>
				<h1 class="page-heading" align="center">NEW USER REGISTRATION LIST</h1>
				<center><div id="form">
					<table>
						<tr id="tr">
							...
							<td><th><center><b>username</b></center></th></td>
							<td><th><center><b>password</b></center></th></td>
							
							
						</tr>
						<?php
							$q=$db->query("SELECT * FROM newuser");
						...
						<tr>
							...
							<td><th><center><?= $r1->username; ?></center></th></td>
							<td><th><center><?= $r1->password; ?></center></th></td>
